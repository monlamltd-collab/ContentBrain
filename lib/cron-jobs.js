...
// review API sends same-day Tue/Thu engine output immediately; this sweep is
// for manual/off-day submissions and missed notifications.
cron.schedule('15 7 * * 2,4', async () => {
  console.log(`[${new Date().toISOString()}] Tue/Thu queued blog review sweep...`);
