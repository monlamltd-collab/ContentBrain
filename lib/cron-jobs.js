...
//   05:45        Reddit scraper (Crawlee-first) → scraped_articles + briefs
...
// 07:00 generation window. Crawlee-first (Firecrawl enhanced-proxy bypass only
// when Reddit 403-blocks Crawlee) extraction of top weekly threads from the
