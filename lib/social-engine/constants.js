...
const SOCIAL_TYPE_LIST = Object.freeze([
  'hero-album', 'niche-hook', 'superlative-reel', 'curiosity-gap',
  'lot-of-day-traffic', 'regional-roundup', 'data-shock',
]);
...
const BREAKOUT_THRESHOLD = 2.5;        // engagement Z-score to mark as breakout
